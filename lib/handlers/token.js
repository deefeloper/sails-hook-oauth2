...
module.exports = function (sails, hook, config) {
  return function (req, res) {
    ...
    function afterAccessToken (client, skipRefreshToken, err, accessToken, expiresIn) {
      ...
      config.generateRefreshToken(client, null, afterRefreshToken.bind(null, accessToken, expiresIn));
    }
    ...
    function afterClientCheck (err, client) {
      ...
      if (!refreshToken) {
        return config.response.fail(res, new Error('Missing refresh token'));
      }
